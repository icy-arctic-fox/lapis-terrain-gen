...
{
	public class IronBootsItem : EnchantableItem
	{
		/// <summary>
		...
		protected IronBootsItem (short data)
			: base(data)
		{
			// ...
		}
		...
		/// <param name="name">Visible name of the item</param>
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		protected IronBootsItem (short data, string name, IEnumerable<string> lore)
			: base(data, name, lore)
		{
			// ...
		}
		...
		/// <param name="enchantments">Collection of enchantments the item has</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected IronBootsItem (short data, IEnumerable<Enchantment> enchantments)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected IronBootsItem (short data, IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
