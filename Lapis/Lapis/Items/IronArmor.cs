...
namespace Lapis.Items
{
	...
	/// </summary>
	public abstract class IronArmor : IronBaseItem, IArmorItem
	{
		/// <summary>
		...
		protected IronArmor (string name, IEnumerable<string> lore)
			: base(name, lore)
		{
			// ...
		}
		...
		protected IronArmor (IEnumerable<Enchantment> enchantments)
			: base(enchantments)
		{
			// ...
		}
		...
		/// <param name="enchantments">Collection of enchantments the item has</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected IronArmor (short damage, IEnumerable<Enchantment> enchantments)
		...
		/// <param name="enchantments">Collection of enchantments the item has</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected IronArmor (short damage, int repairCost, IEnumerable<Enchantment> enchantments)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected IronArmor (IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected IronArmor (short damage, IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected IronArmor (short damage, int repairCost, IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
