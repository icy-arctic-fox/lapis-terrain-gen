...
{
	public class IronHelmetItem : EnchantableItem
	{
		/// <summary>
		...
		protected IronHelmetItem (short data)
			: base(data)
		{
			// ...
		}
		...
		/// <param name="name">Visible name of the item</param>
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		protected IronHelmetItem (short data, string name, IEnumerable<string> lore)
			: base(data, name, lore)
		{
			// ...
		}
		...
		/// <param name="enchantments">Collection of enchantments the item has</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected IronHelmetItem (short data, IEnumerable<Enchantment> enchantments)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected IronHelmetItem (short data, IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
