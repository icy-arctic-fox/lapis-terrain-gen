...
namespace Lapis.Items
{
	public class GoldShovelItem : EnchantableItem
	{
		...
		/// </summary>
		/// <remarks>This value is always ItemType.GoldShovel</remarks>
		public override short ItemId
		{
			get { return (short)ItemType.GoldShovel; }
		}
		...
		/// <summary>
		/// Creates a new gold shovel item from its NBT node data
		/// </summary>
		...
		public GoldShovelItem (Node node)
			: base(node)
		{
			// ...
		}
