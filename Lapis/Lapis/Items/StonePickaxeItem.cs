...
{
	public class StonePickaxeItem : EnchantableItem
	{
		/// <summary>
		...
		protected StonePickaxeItem (short data)
			: base(data)
		{
			// ...
		}
		...
		/// <summary>
		/// Creates a new stone pickaxe item with no enchantments
		/// </summary>
		...
		/// <param name="name">Visible name of the item</param>
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		protected StonePickaxeItem (short data, string name, IEnumerable<string> lore)
			: base(data, name, lore)
		{
			// ...
		}
		...
		/// <param name="enchantments">Collection of enchantments the item has</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected StonePickaxeItem (short data, IEnumerable<Enchantment> enchantments)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected StonePickaxeItem (short data, IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
		...
		/// <summary>
		/// Creates a new stone pickaxe item from its NBT node data
		/// </summary>
