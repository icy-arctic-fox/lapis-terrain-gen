...
namespace Lapis.Items
{
	...
	public abstract class WoodItem : DamageableItem
	{
		...
		protected WoodItem (short damage, int repairCost)
		...
		protected WoodItem (string name, IEnumerable<string> lore)
			: base(name, lore)
		{
			// ...
		}
		...
		/// <param name="name">Visible name of the item</param>
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		protected WoodItem (short damage, string name, IEnumerable<string> lore)
		...
		/// <param name="name">Visible name of the item</param>
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		protected WoodItem (short damage, int repairCost, string name, IEnumerable<string> lore)
		...
		protected WoodItem (IEnumerable<Enchantment> enchantments)
			: base(enchantments)
		{
			// ...
		}
		...
		/// <param name="enchantments">Collection of enchantments the item has</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected WoodItem (short damage, IEnumerable<Enchantment> enchantments)
		...
		/// <param name="enchantments">Collection of enchantments the item has</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected WoodItem (short damage, int repairCost, IEnumerable<Enchantment> enchantments)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected WoodItem (IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected WoodItem (short damage, IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected WoodItem (short damage, int repairCost, IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
