...
namespace Lapis.Items
{
	...
	public abstract class GoldTool : DamageableItem, IToolItem
	{
		...
		protected GoldTool (string name, IEnumerable<string> lore)
			: base(name, lore)
		{
			// ...
		}
		...
		protected GoldTool (IEnumerable<Enchantment> enchantments)
			: base(enchantments)
		{
			// ...
		}
		...
		/// <param name="enchantments">Collection of enchantments the item has</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected GoldTool (short damage, IEnumerable<Enchantment> enchantments)
		...
		/// <param name="enchantments">Collection of enchantments the item has</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected GoldTool (short damage, int repairCost, IEnumerable<Enchantment> enchantments)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected GoldTool (IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected GoldTool (short damage, IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
		...
		/// <param name="lore">Additional description (or "lore") displayed on the item</param>
		/// <exception cref="ArgumentNullException">Thrown if <paramref name="enchantments"/> is null</exception>
		protected GoldTool (short damage, int repairCost, IEnumerable<Enchantment> enchantments, string name, IEnumerable<string> lore)
